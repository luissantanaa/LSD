...
SIGNAL \inst|output[0]~1_combout\ : std_logic;
SIGNAL \inst|ALT_INV_output[1]~0_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\inst|ALT_INV_output[1]~0_combout\ <= NOT \inst|output[1]~0_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \inst|ALT_INV_output[1]~0_combout\,
	devoe => ww_devoe,
	o => \LEDR[1]~output_o\);
...
-- Equation(s):
-- \inst|output[1]~0_combout\ = (!\SW[3]~input_o\ & !\SW[2]~input_o\)
...
\inst|output[0]~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|output[0]~1_combout\ = (\SW[3]~input_o\) # ((!\SW[2]~input_o\ & \SW[1]~input_o\))
...
PORT MAP (
	...
	datab => \SW[2]~input_o\,
	datac => \SW[1]~input_o\,
	combout => \inst|output[0]~1_combout\);
